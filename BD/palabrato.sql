...
VALUES
  (
    ...
    , 'AMIGO'
    , 5
    , 'Persona con la que se mantiene una relación de afecto.'
    , 'Compañero cercano.'
    , 'Aguda'
  )
  , (
    ...
    , 'ARBOL'
    , 5
    , 'Planta de tronco leñoso que se ramifica a cierta altura.'
    , 'Da sombra.'
    , 'Grave'
  )
  , (
  ...
  , (
    ...
    , 'PERRO'
    , 5
    , 'Animal doméstico considerado el mejor amigo del hombre.'
    , 'Animal que ladra.'
    , 'Grave'
  )
  , (
  ...
  , (
    ...
    , 'MANGO'
    , 5
    , 'Fruta tropical dulce y carnosa.'
    , 'Fruta amarilla o roja.'
    , 'Grave'
  )
  , (
    7
  ...
  , (
    ...
    , 'FUEGO'
    , 5
    , 'Fenómeno de combustión que emite calor y luz.'
    , 'Lo contrario al agua.'
    , 'Grave'
  )
  , (
    9
  ...
  , (
    ...
    , 'CIELO'
    , 5
    , 'Espacio en que se mueven los astros.'
  ...
  , (
    ...
    , 'MARCO'
    , 5
    , 'Estructura que rodea un objeto.'
    , 'Borde de un cuadro.'
    , 'Grave'
  )
  , (
    ...
    , 'LENTE'
    , 5
    , 'Pieza de vidrio para ver mejor.'
    , 'Lo usan los miopes.'
    , 'Grave'
  )
  , (
  ...
  , (
    ...
    , 'ARENA'
    , 5
    , 'Conjunto de partículas finas en la playa.'
    , 'Se pega en los pies.'
    , 'Grave'
  )
  , (
  ...
  , (
    ...
    , 'PANES'
    , 5
    , 'Alimento hecho de harina.'
    , 'Lo venden en panaderías.'
    , 'Grave'
  )
  , (
    39
  ...
  , (
    ...
    , 'PELOS'
    , 5
    , 'Filamentos que crecen en la piel.'
    , 'Lo cortás en la peluquería.'
    , 'Grave'
  )
  , (
    53
  ...
  , (
    ...
    , 'LECHE'
    , 5
    , 'Bebida blanca de vaca.'
    , 'Se toma en desayunos.'
    , 'Grave'
  )
  , (
    59
  ...
  , (
    ...
    , 'LIBRO'
    , 5
    , 'Conjunto de hojas encuadernadas.'
    , 'Se lee.'
    , 'Grave'
  )
  , (
  ...
  , (
    ...
    , 'GUITA'
    , 5
    , 'Instrumento musical o dinero (arg).'
    , 'Lo tocan músicos.'
    , 'Grave'
  )
  , (
...
VALUES
  (
    1
    , 'Pedrotudo'
    , '$2y$10$J.6Xd0OFpe7QWetqEX2z2uui0U.ptFTNlyA0pB04wjYRRCXqW8WiW'
    , 'pedroicoppola@gmail.com'
    , 58
    , 13925
    , NULL
    , '2025-09-23 23:54:42'
  ...
  , (
    2
    , 'pelotudo'
    , '$2y$10$uU0Pq7wHOgqD4NYnSHHOIOi72nZDeBC394AVzRu4yl2NpTcKTJYIe'
    , 'asd@gmail.com'
    , 48
    , 12000
    , NULL
...
--
ALTER TABLE `palabras` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT
, AUTO_INCREMENT = 88;

--
-- AUTO_INCREMENT de la tabla `partidas`
--
ALTER TABLE `partidas` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT
, AUTO_INCREMENT = 12;

--
-- AUTO_INCREMENT de la tabla `pistas`
--
ALTER TABLE `pistas` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ON DELETE SET NULL
, ADD CONSTRAINT `partidas_ibfk_2` FOREIGN KEY (`id_palabra`) REFERENCES `palabras` (`id`)
ON DELETE SET NULL;
COMMIT;
